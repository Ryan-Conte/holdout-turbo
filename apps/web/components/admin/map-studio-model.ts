...
export const MAP_OBJECT_PALETTE: {
  ...
  { id: 'moose', label: 'Bull moose', group: 'Wildlife', color: '#634930', template: { type: 'moose' } },
  { id: 'raccoon', label: 'Raccoon', group: 'Wildlife', color: '#85827a', template: { type: 'raccoon' } },
  { id: 'cougar', label: 'Cougar', group: 'Wildlife', color: '#b18456', template: { type: 'cougar' } },
